...
function postFlop(bot) {
    if (!bot.strength) {
        console.error('missing hand strength');
        return NEUTRAL;
    }
    console.log('hand strength is ' + bot.strength);
    return bot.strength < 9000 ? WEAK : bot.strength > 11000 ? STRONG : NEUTRAL;
}
