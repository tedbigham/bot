...
function Events(bot) {
    ...
    this.tableBuyIn = function(event) {
        if (event.ids.userID == bot.userID) {
            bot.seat = event.nums.seat;
            bot.chipStack = event.chips.chipStack;
            bot.tableID = event.tableID;
        }
    };
    ...
    this.handStarted = function(event) {
        bot.handId = event.ids.handID;
    };

    //{"nums":{"seat":8},"eventID":1,"eventName":"handDealerButton","event":"handDealerButton","ids":{"tableID":"66ed64c2-dd43-11e6-8b52-56847afe9799"}}
    this.handDealerButton = function(event) {
        bot.dealerSeat = event.nums.seat;
    };
    ...
    // {"nums":{"seats":[7,8]},"eventID":1,"eventName":"handCardsDealt","event":"handCardsDealt","ids":{"tableID":"66ed64c2-dd43-11e6-8b52-56847afe9799"}}
    this.handCardsDealt = function(event) {
        bot.hands++;
    };
    ...
    this.handAllCardsRemoved = function(event) {
        bot.newHand();
    };

    // {"ids":{"tableID":"a2542a30-d3f2-11e6-8a5c-56847afe9799"},"event":"handChipsReturned","chips":{"chips":50,"betStack":50,"chipStack":11660},"nums":{"seat":7}}
    this.handChipsReturned = function(event) {
    };
    ...
    this.playerLevelChange = function(event) {
        console.log('level ' + event.nums.level);
    }
